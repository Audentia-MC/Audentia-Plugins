...
public class PlayerDamage {
    ...
    public PlayerDamage(RolesRepository rolesRepository, BalanceManage balanceManage, ColiseumLocationRepository coliseumLocationRepository) {
    ...
    public void dealDamage(UUID damagedUUID, UUID damagerUUID, Location location) {
