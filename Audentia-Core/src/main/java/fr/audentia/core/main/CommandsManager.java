...
public class CommandsManager {
    ...
    private Map<PluginCommand, CommandExecutor> loadCommands() {
        ...
        loadedCommands.put(getCommand("deletehome"), new CommandDeleteHome(provider.setHomeManage));
        ...
        loadedCommands.put(getCommand("reloadAllPNJ"), new CommandReloadAllPNJ(provider.rolesRepository, provider.bankNpcSpawn, provider.npcSpawn));
